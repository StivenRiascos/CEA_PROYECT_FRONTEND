...
export class AnimalsComponent implements OnInit {
  ...
  loadAnimals(): void {
    ...
    this.animals = [
      // AVES
      {
        ...
        description: 'La guacamaya roja es una de las aves más coloridas y emblemáticas de la Amazonía. Su plumaje es principalmente escarlata con algunas plumas azules y amarillas en las alas.',
      ...
      },
      {
        ...
        description: 'El tucán toco es la especie más grande de tucán, reconocible por su enorme pico naranja y amarillo. A pesar del tamaño de su pico, es muy ligero debido a su estructura hueca.',
      ...
      },
      {
        ...
        description: 'El águila harpía es una de las aves rapaces más poderosas del mundo y la más grande de la Amazonía. Posee garras del tamaño de las de un oso grizzly.',
      ...
      },
      {
        ...
        description: 'Este colibrí es conocido por la forma única de su cola, que termina en dos largas plumas con puntas en forma de espátula. Es una de las especies más raras y extraordinarias de colibríes.',
      ...
      },
      {
        ...
        description: 'El hoatzin, también conocido como "pájaro prehistórico", es una especie única con características primitivas. Las crías nacen con garras en sus alas que les permiten trepar por los árboles.',
      ...
      },
      {
        ...
        description: 'El quetzal resplandeciente es considerado una de las aves más hermosas del mundo, con su plumaje verde iridiscente y las largas plumas de la cola en los machos.',
      ...
      },
      {
        ...
        description: 'El gallito de las rocas es conocido por su brillante plumaje naranja-rojo y su elaborado ritual de apareamiento. Los machos se reúnen en áreas especiales llamadas "leks" para competir por las hembras.',
      ...
      },
      {
        ...
        description: 'El búho cornudo es una de las especies de búhos más grandes y adaptables. Se caracteriza por los penachos de plumas en su cabeza que parecen cuernos.',
      ...
      },
      {
        ...
        description: 'El martín pescador amazónico es un ave acuática de tamaño mediano con un plumaje verde brillante en la parte superior y blanco en la parte inferior. Tiene un pico largo y fuerte para capturar peces.',
      ...
      },
      {
        ...
        description: 'El cóndor andino es una de las aves voladoras más grandes del mundo. Con una envergadura que puede superar los 3 metros, es un símbolo de los Andes y parte importante de la mitología indígena.',
      ...
      // TERRESTRES
      {
        ...
        description: 'La tortuga matamata es una de las especies más extrañas de tortugas, con un caparazón que parece corteza de árbol y una cabeza triangular con protuberancias que le dan un aspecto único.',
      ...
      },
      {
        ...
        description: 'La iguana verde es un gran lagarto arborícola conocido por su coloración verde brillante y su cresta dorsal distintiva. Puede alcanzar hasta 2 metros de longitud incluyendo la cola.',
      ...
      },
      {
        ...
        description: 'La anaconda verde es una de las serpientes más grandes del mundo, pudiendo alcanzar más de 9 metros de longitud. Es una constrictora que habita en ambientes acuáticos de la Amazonía.',
      ...
      },
      {
        ...
        description: 'La rana venenosa azul es conocida por su brillante coloración azul eléctrico, que advierte a los depredadores de su toxicidad. Es una de las ranas más vistosas de la Amazonía.',
      ...
      },
      {
        ...
        description: 'El caimán negro es el más grande de los caimanes, pudiendo alcanzar hasta 6 metros de longitud. Su coloración oscura le ayuda a camuflarse en las aguas turbias de la Amazonía.',
      ...
      },
      {
        ...
        description: 'La boa arcoíris es una serpiente no venenosa conocida por los reflejos iridiscentes de su piel que brillan con los colores del arcoíris bajo la luz directa.',
      ...
      },
      {
        ...
        description: 'La tortuga de río amazónica es una de las tortugas de agua dulce más grandes del mundo. Las hembras pueden pesar hasta 90 kg y medir más de 1 metro de longitud.',
      ...
      },
      {
        ...
        description: 'El lagarto basilisco, también conocido como "lagarto Jesús Cristo", es famoso por su capacidad de correr sobre el agua utilizando sus patas traseras. Posee una cresta distintiva en la cabeza y espalda.',
      ...
      },
      {
        ...
        description: 'Las ranas de cristal son conocidas por su piel translúcida que permite ver sus órganos internos, incluyendo el corazón latiendo. Son pequeñas y generalmente de color verde claro.',
      ...
      },
      {
        ...
        description: 'El cocodrilo del Orinoco es uno de los cocodrilos más grandes y en mayor peligro de extinción. Puede alcanzar hasta 6.6 metros de longitud y es conocido por su agresividad.',
      ...
      // MAMÍFEROS
      {
        ...
        description: 'El jaguar es el felino más grande de América y el tercero más grande del mundo. Es un depredador tope con un poderoso mordisco que puede perforar cráneos y caparazones de tortugas.',
      ...
      },
      {
        ...
        description: 'El mono tití o tamarino es un pequeño primate reconocible por el pelo blanco que rodea su cara, similar a una melena. Es uno de los primates más pequeños, pesando apenas 500 gramos.',
      ...
      },
      {
        ...
        description: 'El tapir amazónico es el mamífero terrestre más grande de Sudamérica, pudiendo pesar hasta 300 kg. Su característica más distintiva es su pequeña trompa prensil.',
        habitat: 'Bosques tropicales cerca de cuerpos de agua',
      ...
      },
      {
        ...
        description: 'El perezoso de tres dedos es conocido por su lento movimiento y estilo de vida. Pasa casi toda su vida colgado boca abajo en los árboles, incluso duerme en esta posición.',
      ...
      },
      {
        ...
        description: 'La capibara es el roedor más grande del mundo, pudiendo pesar hasta 65 kg. Tiene un cuerpo robusto, hocico cuadrado y patas parcialmente palmeadas que lo hacen excelente nadador.',
      ...
      },
      {
        ...
        description: 'El ocelote es un felino mediano con un hermoso pelaje moteado que le proporciona un excelente camuflaje en la selva. Es un cazador nocturno ágil y sigiloso.',
      ...
      },
      {
        ...
        description: 'El delfín rosado o boto es una especie única de delfín de río con una coloración rosada distintiva. Tiene un hocico largo y una frente abultada, así como aletas pectorales grandes.',
      ...
      },
      {
        ...
        description: 'El oso hormiguero gigante es un mamífero inconfundible por su hocico alargado, lengua extensible y pelaje grueso con marcas distintivas. A pesar de su nombre, no está relacionado con los osos.',
      ...
      },
      {
        ...
        description: 'La nutria gigante es la especie más grande de nutria, pudiendo alcanzar hasta 1.8 metros de longitud. Vive en grupos familiares y es conocida por su comportamiento social y vocal.',
        habitat: 'Ríos, lagos y pantanos de la cuenca amazónica',
      ...
      },
      {
        ...
        description: 'El mono aullador es conocido por su potente vocalización que puede escucharse hasta a 5 km de distancia. Tiene un pelaje rojizo y una característica barba.',
        habitat: 'Dosel de bosques tropicales',
  ...
  filterByCategory(category: 'aves' | 'terrestres' | 'mamiferos' | 'todos'): void {
    this.selectedCategory = category;
    
    if (category === 'todos') {
      this.filteredAnimals = this.animals;
    } else {
      this.filteredAnimals = this.animals.filter(animal => animal.category === category);
    }
  }
